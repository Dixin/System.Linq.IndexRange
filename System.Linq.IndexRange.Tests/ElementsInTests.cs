namespace Linq.Range.Tests
{
    ...
    public class ElementsInTests
    {
        ...
        public void NonEmptySourceTests()
        {
            ...
            // Invalid range.
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[3..2].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(3..2).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[6..^5].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(6..^5).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[3..^8].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(3..^8).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[^6..^7].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(^6..^7).ToArray());

            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[3..2].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(3..2).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[6..^5].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(6..^5).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[3..^8].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(3..^8).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[^6..^7].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(^6..^7).ToArray());
        }
        ...
        public void EmptySourceTests()
        {
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..7].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(2..7).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..^4].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(2..^4).ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..7].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(2..7).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..^4].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(2..^4).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[^7..^4].ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(2..).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[..^4].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(..^4).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[..6].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(..6).ToArray());

            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[^9..].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(^9..).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(2..).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[..^4].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(..^4).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[..6].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(..6).ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..3].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(2..3).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..^7].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(2..^7).ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..3].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(2..3).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[2..^7].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(2..^7).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[^5..^4].ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[0..1].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(0..1).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[0..^9].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(0..^9).ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[0..1].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(0..1).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[0..^9].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(0..^9).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[^10..^9].ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[9..10].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(9..10).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[9..^0].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(9..^0).ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[9..10].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(9..10).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[9..^0].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(9..^0).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[^1..^0].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(^1..^0).ToArray());

            // No element.
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[3..3].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(3..3).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[6..^4].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.ElementsIn(6..^4).ToArray());
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[3..3].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(3..3).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[6..^4].ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source.Hide().ElementsIn(6..^4).ToArray());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => source[3..^7].ToArray());
